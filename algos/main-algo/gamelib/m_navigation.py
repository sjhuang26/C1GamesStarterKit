...
class ShortestPathFinder:
    ...
    def util_find_path(self, start_location, target_edge):
        
        
    def navigate_multiple_endpoints(self, start_point, end_points, game_state, path_map):
